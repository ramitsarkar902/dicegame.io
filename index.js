...
var player2name=prompt("Enter second player name");

document.getElementById("first").innerHTML=player1name;

document.getElementById("second").innerHTML=player2name;
